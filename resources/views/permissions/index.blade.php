...
@section('content')
    ...
    <h1 class="mb-3">Manage your Permissions here then start giving them to the Roles then give the roles to users to accomplish security in your Application.</h1>
