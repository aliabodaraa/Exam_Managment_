    ...
    <div class="bg-light p-4 rounded">
        <div class="row">
            <div class="col-lg-10 col-sm-10 col-xs-10">
                <h1 class="text-center m-0"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-building" viewBox="0 0 16 16">
            ...
            <div class="col-lg-2 col-sm-2 col-xs-2">
                <div class="collect-index-btns gap-1">
                    ...
                    <a href="{{ route('rooms.create') }}" class="btn btn-primary float-right mb-4"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-building-add" viewBox="0 0 16 16">
                            ...
                            <tr class="room" id="{{$room->id}}">
                                ...
                                @if(Auth::user()->temporary_role == "رئيس شعبة الامتحانات" || Auth::user()->temporary_role == "عميد")
                                    <td style="display:flex;align-items:baseline;">
                                            <a href="{{ route('rooms.edit', $room->id) }}" class="btn btn-info btn-sm me-2 btn-close-white"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-building-gear" viewBox="0 0 16 16">
                                                <path d="M2 1a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6.5a.5.5 0 0 1-1 0V1H3v14h3v-2.5a.5.5 0 0 1 .5-.5H8v4H3a1 1 0 0 1-1-1V1Z"/>
                                            ...
                                            <a href="#exampleModalToggle{{ $room->id }}" data-bs-toggle="modal" class="btn btn-danger btn-sm" >
                                    ...
                                    @include('layouts.partials.popUpDelete',['route_info' => ['rooms.destroy', $room->id],'description' => "هل أنت متأكد أنك تريد حذف القاعة $room->room_name"])
                                @endif
                            </tr>
                        @endforeach
                </tbody>
