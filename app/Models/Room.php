...
class Room extends Model
{
    ...
    public function courses(){//many to many between Room & Course
        return $this->belongsToMany('App\Models\Course','course_room_user')->withPivot('user_id','room_id','date','time','roleIn','num_student_in_room','rotation_id');
    }
    public function users(){//many to many between Room & User
        return $this->belongsToMany('App\Models\User','course_room_user')->withPivot('course_id','room_id','date','time','roleIn','num_student_in_room','rotation_id');
    }
